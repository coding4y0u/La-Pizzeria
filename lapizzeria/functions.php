...
function lapizzeria_setup() {
 ...
 add_image_size('specialty-portrait', 436, 530, true);
...
//  wp_register_style( 'fontawesome', get_template_directory_uri( 'fontawesome' ) . '/css/fontawesome.css', array(), '5.8.1' );
 wp_register_style( 'all', get_template_directory_uri( 'all' ) . '/css/all.css', array(), '5.8.1' );
...
//  wp_enqueue_style('fontawesome');
 ...
 wp_register_script('script', get_template_directory_uri() . '/js/scripts.js', array('jquery', 'fluidboxjs'), '1.0.0', true);
...
function lapizzeria_specialties() {
  $labels = array(
    ...
    'singuar_name'       => _x('Pizza', 'post type singular name', 'lapizzeria'),
